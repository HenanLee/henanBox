...
使用说明：（仅限 v 1.50-1.63 版本可解锁，只有 v1.50 版本可以使用小组件）
...
^https?:\/\/api\.revenuecat\.com\/v1\/(receipts|subscribers\/\$RCAnonymousID%3A\w{32})$ url script-response-body https://raw.githubusercontent.com/HenanLee/henanBox/main/QX/baiyun.js
